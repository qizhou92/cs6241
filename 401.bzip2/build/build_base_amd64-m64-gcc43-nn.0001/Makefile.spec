...
CC               = /nethome/cporter35/llvm/build/Debug+Asserts/bin/clang
COPTIMIZE        = -O2 -fno-strict-aliasing
CXX              = /nethome/cporter35/llvm/build/Debug+Asserts/bin/clang++
...
compwhite        = 
configdir        = config
configpath       = /nethome/girish/Developement/llvm3.8.0/Workloads/spec2006/config/jedi025
copies           = 1
datadir          = data
delay            = 0
deletebinaries   = 0
...
log_line_width   = 0
log_timestamp    = 0
logname          = /nethome/girish/Developement/llvm3.8.0/Workloads/spec2006/result/CPU2006.126.log
lognum           = 126
mach             = default
mail_reports     = all
mailcompress     = 0
...
path             = /nethome/girish/Developement/llvm3.8.0/Workloads/spec2006/benchspec/CPU2006/401.bzip2
plain_train      = 1
preenv           = 1
prefix           = 
prepared_by      = 
...
run              = all
rundir           = run
runspec          = /nethome/girish/Developement/llvm3.8.0/Workloads/spec2006/bin/runspec --fake --loose --size ref --tune base --config jedi025 bzip2
safe_eval        = 1
...
tester           = 
top              = /nethome/girish/Developement/llvm3.8.0/Workloads/spec2006
train_with       = train
tune             = base
uid              = 1051
unbuffer         = 1
