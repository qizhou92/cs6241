...
.Lfunc_end12:
	...
	.align	8
.LCPI13_0:
	.quad	4636244375849748494     # double 92.995249373169116
	.text
	.globl	main
	.align	16, 0x90
	.type	main,@function
...
.Lfunc_end14:
	...
	.align	8
.LCPI15_0:
	.quad	4614859467388319151     # double 3.4092944415594597
	.text
...
.Lfunc_end32:
	...
	.align	8
.LCPI33_0:
	.quad	4636279574888011770     # double 93.495457792043367
	.text
...
.Lfunc_end42:
	...
	.align	8
.LCPI43_0:
	.quad	4636271996106464477     # double 93.387756828556533
	.text
...
.LJTI49_0:
	...
	.align	8
.LCPI50_0:
	.quad	4614884688565415161     # double 3.4204948941675153
	.section	.rodata.cst16,"aM",@progbits,16
	.align	16
.LCPI50_1:
	.zero	16
...
.Lfunc_end53:
	...
	.align	8
.LCPI54_0:
	.quad	4614873166822878445     # double 3.4153782126282892
	.text
	.globl	BZ2_bzread
	.align	16, 0x90
	.type	BZ2_bzread,@function
...
.Lfunc_end54:
	...
	.align	8
.LCPI55_0:
	.quad	4636277662460629109     # double 93.468280564354998
	.text
	.globl	BZ2_bzwrite
	.align	16, 0x90
	.type	BZ2_bzwrite,@function
